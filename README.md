...
In this project, a Fully Convolution Network (FCN) is created and trained on the Kitti Vision Benchmark set.  The parameters below are the values used to train this dataset.
